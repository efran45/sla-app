...
SLA_DEFINITIONS = {
    ...
    "resolution_config": {
        ...
        "description": "Time from ACS ticket creation to linked LPM ticket reaching 'deployed to UAT', 'Waiting for Client UAT/Signoff', or 'done'",
        "source_project": PROJECT_A,
        "target_project": PROJECT_B,
        "health_plan_field": "Health plan",
        "health_plan_value": "LA Blue",
        "target_statuses": ["deployed to UAT", "Waiting for Client UAT/Signoff", "done"],
